...
echo -e "\nThis script reads <DATA_DIR>/<CLUSTER>/SYSTEMS file for hosts."
echo    "The hosts are FQDN or IP address per line for all hosts in a cluster."
echo    "Lines in <SYSTEMS_FILE> that begin with a # are comments.  The <SYSTEMS_FILE> is"
...
echo    "<SYSTEMS_FILE> can be entered on the command line or environment variable."
