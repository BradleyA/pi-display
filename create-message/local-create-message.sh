#!/bin/bash
# 	create-message/local-create-message.sh  3.236.378  2018-11-11T21:30:29.110651-06:00 (CST)  https://github.com/BradleyA/pi-display  uadmin  six-rpi3b.cptx86.com 3.235  
